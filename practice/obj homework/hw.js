...
const k_users = users.filter(el => el.username[0].toLocaleLowerCase === 'k');
// let kNames = [];
// users.forEach(element => {
//    if (element.name.startsWith("K")) {
//     kNames.push(element)
//    }
// });
// console.log(kNames);
...
const usersInfo = users.map(({name,phone,address}) => `${name}, ${phone} ( ${address.city},  ${address.zipcode})`)
// let userInfo = [];
// users.forEach(elem => {
//    let info = `${elem.name}, ${elem.phone} ( ${elem.address.city},  ${elem.address.zipcode}) `;
//    userInfo.push(info);
//    return;
// });
...
// let usersWeb = [];
// users.forEach(el => usersWeb.push(el.website));
...
// let usersCompany = [];
// users.forEach(el => usersCompany.push(el.company));
...
// let numbers1= [];
// users.forEach(el => {
//     if (el.phone.startsWith("1")){
//         numbers1.push(el.phone);
//     }
//     return;
// });
